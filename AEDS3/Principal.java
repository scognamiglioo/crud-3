...
class Game {
    ...
    private String name, owners, website, developers, release_date;
    ...
    public Game(String name, String owners, String website, String developers, ArrayList<String> languages,
            ArrayList<String> genres, String release_date, int app_id, int age, int dlcs, int upvotes, int avg_playtime,
    ...
    public void fromByteArray(byte[] ba) throws IOException {
        ...
        this.app_id = dis.readInt(); // Le o id da conta do array de bytes
        this.name = dis.readUTF(); // Le o nome da pessoa do array de bytes
        this.release_date = dis.readUTF();
    ...
    public void ler(String line) {
        ...
        if (line.charAt(atr_index) != ',') {
            ...
            while (true) {
                index++;
                if (line.charAt(index) == c_search) {
                    this.release_date = line.substring(atr_index, index);
                    if (c_search == ',')
                        index++;
                    else if (c_search == '\"')
                        index += 2;
    ...
    public void imprimir() {
        ...
        System.out.println(this.app_id + " " + this.name + " " +  (this.release_date) +  " " +
                            String.format("%.2f", this.price) + " " + this.genres);
    }
}
