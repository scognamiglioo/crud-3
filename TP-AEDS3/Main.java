...
public class Main extends CRUD {
    public static void main(String[] args) throws IOException {
        ...
        while (loop) { // Loop do menu principal
            ...
            System.out.println("|11 - Cifra de Cesar       |");
            System.out.println("|11 - Substituição         |");
            ...
            } while (opcao < 0 || opcao > 14); // Enquanto a opcao for invalida continua no loop
            ...
            switch (opcao) {
                ...
                case 2:
                    ...
                    cifradecesar.descifraCesar("teste.bin");
                ...
                case 8:
                    ...
                    break;
                case 9:
                    System.out.println("____________BOYER-MOORE____________");
                ...
                case 10:
                    ...
                    break;
                case 11:
                    System.out.println("____________CIFRA DE CESAR____________");
                    int auxTipo = 0;
                    System.out.println("Escolha o tipo de cifra:");
                    ...
                    if (auxTipo == 1) {
                        System.out.println("Digite o nome do arquivo de dados:");
                        String nomeArquivo = sc.next();
                        cifradecesar.cifraCesar(nomeArquivo);
                    } else if (auxTipo == 2) {
                        System.out.println("Digite o nome do arquivo de dados:");
                        String nomeArquivo = sc.next();
                        cifradecesar.descifraCesar(nomeArquivo);
                    }
                    break;     
                    
                case 12:
                    System.out.println("____________CIFRA POR SUBSTITUIÇÃO____________");
                    int auxTipo2 = 0;
                    System.out.println("Escolha o tipo de cifra:");
                    System.out.println("1) Cifrar");
                    System.out.println("2) Decifrar");
                    ...
                    if (auxTipo2 == 1) {
                        System.out.println("Digite o nome do arquivo de dados:");
                        String nomeArquivo = sc.next();
                        criptografiasubstituicao.cifrarArquivo(nomeArquivo);
                    } else if (auxTipo2 == 2) {
                        System.out.println("Digite o nome do arquivo de dados para que salve o decifrado:");
                        String nomeArquivo = sc.next();
                        criptografiasubstituicao.descifrarArquivo(nomeArquivo);
