...
public class Main extends CRUD {
    public static void main(String[] args) throws IOException {
        ...
        RandomAccessFile arvoreBindices = new RandomAccessFile("arvoreBindices", "rw"); // Arquivo de índice Arvore B+
                                                                                         // de ordem 8
        arvoreBM arvoreDeIndices = new arvoreBM(8); // Estrutura de arvire para armazenar o índice localmente
        hashExtensivel.tabelaBuckets indiceHash = new hashExtensivel.tabelaBuckets(); // Estrutura de tabela de buckets
                                                                                     // para armazenar o índice localmente
                ...
                case 5: // ordenação
                    ...
                    switch (tipo) {
                        ...
                        if(tipoLista==1){
                            ...
                            if(listaInvertida.listarValor(raf, valorAux )) System.out.println("\n-> Listado com sucesso!");
                            else System.out.println("\n-> Erro ao listar!");
                        }else if(tipoLista==2){
                            System.out.print("\n-> Digite o ID do jogo: ");
                            int genero = sc.nextInt();
                            if(listaInvertida.listarGenero(raf, genero)) System.out.println("\n-> Listado com sucesso!");
                            else System.out.println("\n-> Erro ao listar!");
                        }else{
